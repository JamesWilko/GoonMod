...
function ColorHSVRGB:SetupLocalization()
	...
	local loc = managers.localization._custom_localizations

	loc["Options_ToggleColorHSV_Title"] = "Use HSV"
	loc["Options_ToggleColorHSV_Message"] = "Use HSV instead of RGB"

	loc["Options_" .. id .. "_RH_Title"] = hsv and "Hue/Red" or "Red/Hue"
	loc["Options_" .. id .. "_GS_Title"] = hsv and "Saturation/Green" or "Green/Saturation"
	loc["Options_" .. id .. "_BV_Title"] = hsv and "Value/Blue" or "Blue/Value"
	loc["Options_" .. id .. "_Example"] = "Color Example"

	loc["Options_" .. id .. "_RH_Desc"] = string.gsub( "Control the {1} of the colour", "{1}", hsv and "Hue" or "Red" )
	loc["Options_" .. id .. "_GS_Desc"] = string.gsub( "Control the {1} of the colour", "{1}", hsv and "Saturation" or "Green" )
	loc["Options_" .. id .. "_BV_Desc"] = string.gsub( "Control the {1} of the colour", "{1}", hsv and "Value" or "Blue" )
	loc["Options_" .. id .. "_ExampleMessage"] = "Re-open this menu to update the color example"

	managers.localization._custom_localizations = loc
